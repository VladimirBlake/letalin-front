...
export default function ServicesServiceSection({ image, title, description }) {
  ...
  return (
    <section className="mt-14 sm:container">
      <h2 className="px-4 font-darco font-bold text-xl">{title}</h2>
      ...
      <div className="px-4 mt-5">
        <div className="flex items-center">
          ...
          <div
            ...
            className="rounded-full w-[20px] h-[20px] border-[1.2px] border-r-black ml-2 relative top-[-2px] flex justify-center items-center"
          >
            <Image
              src={Arrow}
              alt=""
